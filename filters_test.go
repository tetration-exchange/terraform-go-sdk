...
var (
	filtersAPIURL                  = os.Getenv("TETRATION_API_URL")
	filtersAPIKey                  = os.Getenv("TETRATION_API_KEY")
	filtersAPISecret               = os.Getenv("TETRATION_API_SECRET")
	filtersDefaultParentScopeAppId = os.Getenv("TETRATION_ROOT_SCOPE_APP_ID")
