...
var (
	tagsAPIURL               = os.Getenv("TETRATION_API_URL")
	tagsAPIKey               = os.Getenv("TETRATION_API_KEY")
	tagsAPISecret            = os.Getenv("TETRATION_API_SECRET")
	tagsDefaultRootScopeName = os.Getenv("TETRATION_ROOT_SCOPE_APP_NAME")
