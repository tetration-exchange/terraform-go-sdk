...
var (
	rolesAPIURL                = os.Getenv("TETRATION_API_URL")
	rolesAPIKey                = os.Getenv("TETRATION_API_KEY")
	rolesAPISecret             = os.Getenv("TETRATION_API_SECRET")
	rolesRootScopeAppId        = os.Getenv("TETRATION_APP_SCOPE_ID")
	rolesDefaultRootScopeAppId = os.Getenv("TETRATION_ROOT_SCOPE_APP_ID")
