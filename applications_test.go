...
var (
	applicationsAPIURL                = os.Getenv("TETRATION_API_URL")
	applicationsAPIKey                = os.Getenv("TETRATION_API_KEY")
	applicationsAPISecret             = os.Getenv("TETRATION_API_SECRET")
	applicationsDefaultAppScopeId     = os.Getenv("TETRATION_APP_SCOPE_ID")
	applicationsDefaultRootScopeAppId = os.Getenv("TETRATION_ROOT_SCOPE_APP_ID")
