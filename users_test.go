...
var (
	usersAPIURL              = os.Getenv("TETRATION_API_URL")
	usersAPIKey              = os.Getenv("TETRATION_API_KEY")
	usersAPISecret           = os.Getenv("TETRATION_API_SECRET")
	usersDefaultAppScopeId   = os.Getenv("TETRATION_APP_SCOPE_ID")
