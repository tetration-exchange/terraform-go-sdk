...
var (
	FiltersAPIV1BasePath = fmt.Sprintf("%s/filters/inventories", TetrationAPIV1BasePath)
)

// Filter wraps a tetration inventory filter.
...
type Filter struct {
	...
	// Raw query returned by the Tetration API over the wire.
